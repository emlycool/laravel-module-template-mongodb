...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        // \Template\Http\Middleware\TrustHosts::class,
        \Template\Http\Middleware\TrustProxies::class,
        \Fruitcake\Cors\HandleCors::class,
        \Template\Http\Middleware\PreventRequestsDuringMaintenance::class,
    ...
    protected $routeMiddleware = [
        'auth' => \Template\Http\Middleware\Authenticate::class,
